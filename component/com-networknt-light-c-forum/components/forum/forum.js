...
.service('blogBackend', ['$http', function($http) {
    return {
        getForumTree : function (host) {
           var getForumTreeQuery = {
                category : "forum",
                name : "getForumTree",
                readOnly: true,
                data: {
           ...
           return $http.post('api/rs', getForumTreeQuery).then(function (response) {
                return response;
           });
        },
        getForum : function (host, forumRid) {
            var getForumQuery = {
                category : 'forum',
                name : 'getForum',
                readOnly: true,
            ...
            return $http.post('api/rs', getForumQuery).then(function (response) {
                return response;
            });
        },
        getForumPosts : function (host, forumRid, pageNo, itemsPerPage, sortDir, sortBy) {
            var getForumPostsQuery = {
                category : 'blog',
                name : 'getBlogPost',
                readOnly: true,
                data: {
